...
exports.pintar_venta =  function(cliente, objeto){
    ...
    objeto.ventas.forEach(function(element) {
        element.detalles.forEach(function(ele) {
            ...
            texto +=  pintar_derecha(14, date(element.at));
            texto +=  pintar_espacio_sencillo();
        });
    });
